...
- `owner_id` - (Required, Number) The ID of the user who owns this folder. Must correspond to a valid user ID in BeyondTrust Secret Safe.
...
- The `owner_id` must correspond to a valid user ID in BeyondTrust Secret Safe.
